...
/**
 * Represents and additional DataFile attribute. All DataFile attributes will be
 * signed.
 * 
...
public class DataFileAttribute implements Serializable {
    ...
    private DigiDocException validateName(String str) {
        ...
        if (str == null)
            ex = new DigiDocException(DigiDocException.ERR_DATA_FILE_ATTR_NAME, "Attribute name is required", null);
        return ex;
    }
    ...
    private DigiDocException validateValue(String str) {
        DigiDocException ex = null;
        if (str == null)
            ex = new DigiDocException(DigiDocException.ERR_DATA_FILE_ATTR_VALUE, "Attribute value is required", null);
        return ex;
    }
