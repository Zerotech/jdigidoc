...
public interface SignatureService {
     ...
     * and representing an user public key certificate value.
     * 
     * @return X.509 certificate object.
     * @throws DigiDocException
     *             if getting X.509 public key certificate fails or the
     *             requested certificate type X.509 is not available in the
    ...
    /**
     * Method decrypts the data with the RSA private key corresponding to this
     * certificate (which was used to encrypt it). Decryption will be done on
     * the card. This operation closes the possibly opened previous session with
     * signature token and opens a new one with authentication tokne if
     * necessary
     * 
     * @param data
