...
public class EncryptionProperty implements Serializable {
    ...
    private DigiDocException validateName(String str) {
        ...
        if (str == null)
            ex = new DigiDocException(DigiDocException.ERR_XMLENC_ENCPROP_NAME, "Name atribute is required", null);
        return ex;
    }
    ...
    public byte[] toXML() throws DigiDocException {
        ...
        try {
            ...
            if (m_id != null) bos.write(ConvertUtils.str2data(" Id=\"" + m_id + "\""));
            if (m_target != null) bos.write(ConvertUtils.str2data(" Target=\"" + m_target + "\""));
            if (m_name != null) bos.write(ConvertUtils.str2data(" Name=\"" + m_name + "\""));
            bos.write(ConvertUtils.str2data(">"));
            if (m_name != null) bos.write(ConvertUtils.str2data(ConvertUtils.escapeXmlSymbols(m_content)));
            bos.write(ConvertUtils.str2data("</denc:EncryptionProperty>"));
